...
class TrierVenteScreen extends StatefulWidget {
  TrierVenteScreen({Key key}) : super(key: key);
  static const ROUTE = "/filter";
  @override
  _FilterEtatScreenState createState() => _FilterEtatScreenState();
}

class _FilterEtatScreenState extends State<TrierVenteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: dahshboardAppBar(context, title: "Trier Les Ventes"),
      body: Container(
