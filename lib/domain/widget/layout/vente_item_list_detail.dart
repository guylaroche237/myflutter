...
class VenteItemListDetail extends StatelessWidget {
  final Vente livraison;

  const VenteItemListDetail({Key key, this.livraison}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    ...
    return Column(
        ...
        children: [
          Text("Liste Des Produits Vendu", style: ThemeHelper.paragraph(color: Colors.black, isBold: true)),
          SizedBox(height: 8),
          Container(
