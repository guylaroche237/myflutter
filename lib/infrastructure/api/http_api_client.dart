...
class HttpApiClient implements AbstractApiClient {
  final String host = "jsonplaceholder.typicode.com";  //"207.180.229.120:8080";
  final String prefix = "";
  ...
  static Future<dynamic> execAndParseOrFail(AbstractApiRequest request) async {
    ApiResponse response = await HttpApiClient.execOrFail(request);
